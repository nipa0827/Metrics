...
namespace NewsComponents.Utils
{
    ...
    // Adapted from https://raw.githubusercontent.com/dotnet/corefx/628edf4dd6552be37942f937d16b73a37f305f2f/src/System.ServiceModel.Syndication/src/System/ServiceModel/Syndication/DateTimeHelper.cs
    ...
    public static class DateTimeExt
	{
		...
		public static DateTime ParseRfc2822DateTime(string dateTimeString)
		{
            ...
            if (DateTimeHelper.DefaultRss20DateTimeParser(dateTimeString, out var parsed))
		    {
        ...
        internal static class DateTimeHelper
        {
            ...
            public static bool DefaultRss20DateTimeParser(string dateTimeString, out DateTimeOffset dateTimeOffset)
            {
                ...
                // Even though RCS3339 is for Atom, someone might be using this for RSS
            ...
            public static bool DefaultAtom10DateTimeParser(string dateTimeString, out DateTimeOffset dateTimeOffset)
            {
                return Rfc3339DateTimeParser(dateTimeString, out dateTimeOffset);
            }
