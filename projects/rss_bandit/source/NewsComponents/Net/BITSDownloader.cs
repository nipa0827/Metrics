...
namespace NewsComponents.Net
{
        ...
        IDownloader, IBackgroundCopyCallback, IDisposable
    {
        ...
        /// </summary>
        private readonly HybridDictionary bitsDownloaderJobs = new HybridDictionary();
    ...
    public class BitsDownloadErrorException : Exception
    {
        ...
        /// </summary>
        private readonly BG_ERROR_CONTEXT contextForError;
        ...
        /// </summary>
        private readonly string fileLocalName;

        /// <summary>
        /// The remote file name that was downloaded.
        /// </summary>
        private readonly string fileRemoteName;
        ...
        /// Default constructor.
        /// </summary>
        public BitsDownloadErrorException()
        {
        }
