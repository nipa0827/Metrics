...
{
	public class TwitterPluginConfigurationForm : System.Windows.Forms.Form
	{
		...
		public TwitterPluginConfigurationForm(string username, string password, string apiUrl)
		{
			InitializeComponent();
