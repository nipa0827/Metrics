    ...
    internal static class NativeMethods
    {
        ...
        internal sealed class API
        {
            ...
            public static int RemoveListViewGroup(IntPtr listHandle, int index)
            {
                ...
                {
                    throw new Exception("An exception in API.RemoveListViewGroup occured: " + ex.Message);
                }
            }
            ...
            public static void ClearListViewGroup(IntPtr listHandle)
            {
                ...
                {
                    throw new Exception("An exception in API.ClearListViewGroup occured: " + ex.Message);
                }
            }
            ...
            public static void RedrawItems(ListView lst, bool update)
            {
                ...
                {
                    throw new Exception("An exception in API.RedrawItems occured: " + ex.Message);
                }
            }
            ...
            public static void UpdateItems(ListView lst)
            {
                ...
                {
                    throw new Exception("An exception in API.UpdateItems occured: " + ex.Message);
                }
            }
